...
class Config:
    ...
    EMOTION_PROMPT = os.getenv("EMOTION_PROMPT", "Analizza il seguente testo e fornisci un breve report strutturato.  Il report deve includere:  1. Data odierna  2. Una descrizione sintetica dello stato emotivo che emerge dal testo (es. 'sembra triste', 'sembra agitato', 'è arrabbiato', 'è felice', ecc.)  3. 1-2 frasi di spiegazione breve che motivino questa valutazione.  Testo da analizzare: ")
